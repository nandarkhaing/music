            ...
            <div class="home_inner">
                ...
                <div class="home_container">
                    <div class="home_content text-center">
                        ...
                        <div class="home_title"><h4> Artists</h4></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="super_container">
    ...
    <div class="home">
        <div class="home_inner">
            <!-- Image artist: https://unsplash.com/@yoannboyer -->
            <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{asset('frontendtemplate/img/bg-1.jpg')}}" data-speed="0.8"></div>
            <div class="home_container">
                <div class="home_content text-center">
                    <div class="home_subtitle">All Artists</div>
