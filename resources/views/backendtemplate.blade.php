...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Music Admin <sup>3</sup></div>
      </a>
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           {{--  <h6 class="collapse-header">Custom Components:</h6> --}}
            ...
            <a class="collapse-item" href="{{ route('albums.index')}}">Albums</a>
            <a class="collapse-item" href="{{ route('songs.index')}}">Songs</a>
          </div>
        </div>
      </li>
  ...
  <script src="{{asset('backendtemplate/demo/chart-pie-demo.js')}}"></script>
