...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
    	<div class="row">
    		<div class="col">
      		<h1 class="h3 mb-0 text-gray-800">Artist Edit Form</h1>
    		</div>
    	</div>
    </div>
      	...
      	<div class="col-md-12">
      		<form action="{{route('artists.update',$artist->id)}}" method="POST" enctype="multipart/form-data">
			      ...
			      <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          <input type="text" class="form-control" id="inputName" name="name" value="{{$artist->name}}">
			      ...
			      <div class="form-group row {{ $errors->has('dob') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          <input type="text" class="form-control" id="inputDOB" name="dob" value="{{$artist->dob}} ">
			      ...
			      <div class="form-group row {{ $errors->has('gender') ? 'has-error' : '' }}">
			      	...
			      	<div class="col-sm-5">
			      		<select class="custom-select mr-sm-2" id="inputGender"name="gender"value=" {{$artist->gender}} ">
			      ...
			      <div class="form-group row {{ $errors->has('biography') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          <textarea id="inputBiography" class="form-control" name="biography">{{$artist->biography}}</textarea>
